module.exports = {
	...
	adminId: "660364603968061668", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "", //- Bot's Token
	clientId: process.env.clientId || "1232293314125103194", //- ID of the bot
	...
	cookieSecret: "CodingWithMYSTRO is epic", //- Cookie Secret
